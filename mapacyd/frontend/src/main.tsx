...
// Spinner mientras Keycloak inicializa
root.render(
    ...
    if (!canViewMap) {
      root.render(
        <div style={{
          ...
          <p style={{ fontSize: 16, fontWeight: 600, color: '#1c1c1e', margin: 0 }}>Sin acceso</p>
          <p style={{ fontSize: 14, color: '#8e8e93', margin: 0 }}>Tu cuenta no tiene permiso para ver el mapa.</p>
          <button
