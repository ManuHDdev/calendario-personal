...
// deduplica aquí). Única diferencia respecto al original: el nombre de la env
// var es KEYCLOAK_CERTS_URL (igual que panel/storage/ytdl) en vez del
// KEYCLOAK_JWKS_URI propio de mapacyd, para que gastos siga la convención
// mayoritaria del monorepo — así lo pide su lista de env vars documentada.
const CERTS_URL =
