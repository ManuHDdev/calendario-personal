...
root.render(
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
    <div style={{ width: 24, height: 24, border: '2px solid #e5e5ea', borderTopColor: '#ffd60a', borderRadius: '50%', animation: 'spin 700ms linear infinite' }} />
    <style>{`@keyframes spin { to { transform: rotate(360deg); } }`}</style>
  </div>,
);

// gastos es de acceso exclusivo del propietario (rol admin) — mismo patrón
// que panel/frontend/src/main.tsx: login-required + comprobación de rol antes
// de montar la app.
keycloak
