...
/**
 * Contador de uso de una API externa, persistido en Postgres. Una fila por
 * `(api_name, usage_date)`, día natural en UTC — mismo esquema y helpers que
 * paraisos/backend/src/db/usageCounter.ts (ver
 * openspec/changes/2026-09-09-add-api-usage-dashboard/design.md: sin paquete
 * compartido entre subapps, cada uno lleva su propia copia).
 */
