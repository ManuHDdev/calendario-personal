...
// middleware/auth.ts — mismo patrón que ofertas/middleware/scraperAuth.ts
// (ver openspec/changes/2026-09-09-add-api-usage-dashboard/design.md,
// "Exposure: a bearer-token-gated GET .../api/usage per subapp"). Usado
// EXCLUSIVAMENTE por GET /paraisos/api/usage, el consumidor interno de Panel.
 ...
 * Comparación en tiempo constante (timingSafeEqual) — mismo criterio que
 * SCRAPER_API_KEY en ofertas.
 */
